...
# Se o número de observações é grande, é interessante calcular algumas outras medidas de posição. Essas medidas são uma extensão do conceito de mediana.
...
# Esses valores são chamados de Quartis da distribuição (dividem a distribuição em quartas partes) e são representados por Q1 (1º quartil – 25%) 
# e Q3 (3º quartil – 75%). O segundo quartil, Q2, que corresponde a 50%, é a mediana.
...
# O quarto quartil será o último termo do conjunto com 100% dos dados antes dele.

# Exemplo: O horário de funcionamento de um banco já está se esgotando, para adiantar o atendimento dos clientes o gerente decide parar de chamar 
# individualmente e passa a chamar em grupos de 1/4 da quantidade total de clientes na fila. A partir dos números das fichas dos clientes, determine os grupos das 4 chamadas.
...
##### Percentis #####
# Os percentis são os valores que separam um conjunto de dados em 100 partes iguais. O percentil 10 representa o décimo percentil e terá 10% dos dados antes dele, a lógica se seguirá para todo percentil.
...
# menor desvio será a escolhida por ele. A partir dos dados de medida de corte das 3 máquinas, determine qual deve ser a escolhida pelo engenheiro. 
...
# O coeficiente de assimetria é 0.2549279. Como o coeficiente de assimetria é maior que 0, diz-se que a curva apresenta assimetria positiva e a cauda do lado direito 
# da função densidade de probabilidade é maior que no lado esquerdo. Ao observar também o Histograma, percebe-se que há maior densidade de dados do lado direito. 
