...
#Conclusão: a Máquina 1 possui a menor variação dos dados com 0.73 
#Portanto, a máquina a ser escolhida pelo engenheiro será a Maquina 1
...
# Graus de liberdade é a diferença entre a dimensão da amostra (n)
# e a quantidade de parâmetros a serem avaliados na população. 
